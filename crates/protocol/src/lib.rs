...
#[cfg(feature = "grpc")]
pub(crate) mod google_pb {
    include!(concat!("gen/google.api.rs"));
    include!(concat!("gen/google.rpc.rs"));
}

#[cfg(feature = "grpc")]
pub(crate) mod pb {
    include!(concat!("gen/warg.v1.rs"));
}
...
pub mod protobuf {
    ...
    include!(concat!(env!("OUT_DIR"), "/warg.protocol.v1.rs"));
    // Generated by [`pbjson-build`]
    include!(concat!(env!("OUT_DIR"), "/warg.protocol.v1.serde.rs"));
