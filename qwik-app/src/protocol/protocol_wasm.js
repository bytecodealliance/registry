...
const protocol = {
  validate(arg0) {
    ...
    switch (dataView(memory0).getUint8(ret + 24, true)) {
      ...
      case 1: {
        ...
        switch (dataView(memory0).getUint8(ret + 28, true)) {
          case 0: {
            ...
            switch (dataView(memory0).getUint8(ret + 36, true)) {
              ...
              case 1: {
                const ptr11 = dataView(memory0).getInt32(ret + 40, true);
                const len11 = dataView(memory0).getInt32(ret + 44, true);
        ...
        switch (dataView(memory0).getUint8(ret + 48, true)) {
          ...
          case 1: {
            const ptr14 = dataView(memory0).getInt32(ret + 52, true);
            const len14 = dataView(memory0).getInt32(ret + 56, true);
    ...
    const len20 = dataView(memory0).getInt32(ret + 64, true);
    const base20 = dataView(memory0).getInt32(ret + 60, true);
    const result20 = [];
    for (let i = 0; i < len20; i++) {
      const base = base20 + i * 16;
      ...
      const len19 = dataView(memory0).getInt32(base + 12, true);
      const base19 = dataView(memory0).getInt32(base + 8, true);
      const result19 = [];
      for (let i = 0; i < len19; i++) {
        const base = base19 + i * 1;
        let enum18;
    ...
    const len30 = dataView(memory0).getInt32(ret + 72, true);
    const base30 = dataView(memory0).getInt32(ret + 68, true);
    const result30 = [];
    for (let i = 0; i < len30; i++) {
      const base = base30 + i * 44;
      ...
      const ptr22 = dataView(memory0).getInt32(base + 8, true);
      const len22 = dataView(memory0).getInt32(base + 12, true);
      const result22 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr22, len22));
      const ptr23 = dataView(memory0).getInt32(base + 16, true);
      const len23 = dataView(memory0).getInt32(base + 20, true);
      ...
      switch (dataView(memory0).getUint8(base + 24, true)) {
        case 0: {
          ...
          switch (dataView(memory0).getUint8(base + 32, true)) {
            ...
            case 1: {
              const ptr25 = dataView(memory0).getInt32(base + 36, true);
              const len25 = dataView(memory0).getInt32(base + 40, true);
              const result25 = new Uint8Array(memory0.buffer.slice(ptr25, ptr25 + len25 * 1));
              variant26 = result25;
              break;
            }
            default: {
        ...
        case 1: {
          const ptr27 = dataView(memory0).getInt32(base + 28, true);
          const len27 = dataView(memory0).getInt32(base + 32, true);
          const result27 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr27, len27));
          const ptr28 = dataView(memory0).getInt32(base + 36, true);
          const len28 = dataView(memory0).getInt32(base + 40, true);
          const result28 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr28, len28));
          variant29= {
            tag: 'yanked',
            val: {
              by: result27,
    ...
    switch (dataView(memory0).getUint8(ret + 76, true)) {
      ...
      case 1: {
        const len33 = dataView(memory0).getInt32(ret + 84, true);
        const base33 = dataView(memory0).getInt32(ret + 80, true);
        const result33 = [];
        for (let i = 0; i < len33; i++) {
          const base = base33 + i * 16;
          const ptr31 = dataView(memory0).getInt32(base + 0, true);
          const len31 = dataView(memory0).getInt32(base + 4, true);
          const result31 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr31, len31));
          const ptr32 = dataView(memory0).getInt32(base + 8, true);
          const len32 = dataView(memory0).getInt32(base + 12, true);
          const result32 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr32, len32));
          result33.push({
            keyId: result31,
            publicKey: result32,
          });
